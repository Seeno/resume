...
\begin{itemize}
  ...
  \item Created and maintained automation scripts for testing mobile applications before their release
  \item Added functionality to the common aututomation functions for use to all team memebers
  \item Handled daily maintenance for features such as Siri, Pay Bills, Stop Payments, and more
