...
\begin{itemize}
  \item Lead several feature projects for mobile applications that came out to production
  \item Created and maintained automation scripts for testing mobile applications before every application release
  \item Managed Jenkin machines to run nightly automation script runs
