...
\datedsubsection{\textbf{Prodigy Labs} Toronto, Ontario}{May 2018 -- Present}
...
\begin{itemize}
  ...
  \item Oversaw and managed both manual and automated tests for two features
  \item Maintained communications across multiple teams to ensure smooth launches
  \item Tested and successfully released four additonal new features for the RBC mobile app which are received positvely
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  \item Programming Languages: Java (3 years), Javascript(1 year), XML(1 year), JSON(1 year), SQL(1 year)
  \item Platform: Windows
  \item Automation Framework: Appium (1.5 years)
