...
An employment opportunity as an software developer with options to explore and grow in specialized fields.
...
\begin{itemize}
  ...
  \item Implemented Google and Facebook login APIs to create and identify unique users 
  \item Experimented with Google API services such as Google Places and People
